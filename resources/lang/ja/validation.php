...
return [
    ...
    'declined_if' =>
        ':otherが:valueの場合、:attributeは拒否されなければならない。',
    ...
    'prohibits' =>
        ':attribute フィールドは、:other が存在することを禁止します。',
    'regex' => ':attributeには、有効な正規表現を指定してください。',
    'required' => ':attributeは、必ず指定してください。',
    'required_array_keys' =>
        ':attributeフィールドには、：valuesのエントリを含める必要があります。',
    ...
    'attributes' => [
        'individual_num' => '個体番号',
        'first_male_id' => 'オス1の個体番号',
        'second_male_id' => 'オス2の個体番号',
        'add_day' => '導入日',
        'mix_day' => '交配日',
        'born_day' => '出産日',
        'trouble_day' => '日付',
