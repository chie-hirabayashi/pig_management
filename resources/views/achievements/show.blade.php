                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="border-t border-b">
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="text-center py-3 px-6">
                                {{ $achievement['count_mixes_byAge_total'] }} 匹
                            </td>
                            <td class="text-center py-3 px-6">
                                {{ $achievement['count_borns_byAge_total'] }} 匹
                            </td>
                            <td class="text-center py-3 px-6">
                                {{ $achievement['count_bornPigs_byAge_total'] }} 匹
                            </td>
                            <td class="text-center py-3 px-6">
                                {{ $achievement['count_weaningPigs_byAge_total'] }} 匹
                            </td>
                            <td class="text-center py-3 px-6">
