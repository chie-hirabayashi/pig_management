<x-app-layout>
    ...
    <section
        ...
        <form action="{{ route('extracts.index') }}" method="POST"
            ...
            <div class="grid max-w-lg grid-cols-1 gap-6 sm:grid-cols-1">
                ...
                <div class="grid grid-cols-3 mb-1">
                    ...
                    <div class="mt-16 ml-4 text-gray-700">
                        <div class="flex">
                            <input type="radio" name="rotate_operator" id="rotate_operator" value="{{ 1 }}" {{ old('rotate_operator') }}
                        ...
                        <div class="flex">
                            <input type="radio" name="rotate_operator" id="rotate_operator" value="{{ 2 }}" {{ old('rotate_operator') }}
                                class="block rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                ...
                <div class="grid grid-cols-3 mb-1">
                    ...
                    <div class="mt-16 ml-4 text-gray-700">
                        <div class="flex">
                            <input type="radio" name="born_num_operator" value="{{ 1 }}" {{ old('born_num_operator') }}
                                class="block rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                required checked>
                            <p class="text-sm">かつ</p>
                        </div>
                        <div class="flex">
                            <input type="radio" name="born_num_operator" value="{{ 2 }}" {{ old('born_num_operator') }}
                                class="block rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                required>
                            <p class="text-sm">または</p>
                        </div>
    ...
    <script>
        ...
        let radio1 = document.getElementsByName('rotate_operator');
        let radio2 = document.getElementsByName('born_num_operator');
